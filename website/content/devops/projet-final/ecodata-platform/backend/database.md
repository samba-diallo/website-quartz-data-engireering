---
title: "Backend - database.py"
publish: true
---

# Backend - database.py

Configuration de la base de données PostgreSQL et gestion des sessions (32 lignes).
...
[Télécharger database.py](/static/devops/projet-final/backend/database.py)
